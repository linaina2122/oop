...
void Worker::setStat(Statistic s) 
{
   this->stat = s;
}
...
void Worker::deleteTools(Tool* tool) 
{
    ...
    std::vector<Tool*>::iterator it = this->tools.begin();
...
int Tool::getNumberOfTools() const 
{
...
Hammer::Hammer() {
    setNumberOfTools(10); //initialize the value of number of tools
